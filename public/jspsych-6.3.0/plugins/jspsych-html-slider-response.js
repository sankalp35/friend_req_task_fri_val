...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //adding an event listener for the button box responses
    display_element.querySelector('#jspsych-html-slider-response-response').addEventListener("keydown", event => {
      //49 == '1' and 50 == '2'
    if (event.keyCode === 49) {
      display_element.querySelector('#jspsych-html-slider-response-response').stepDown(trial.step);
      display_element.querySelector('#jspsych-html-slider-response-next').disabled = false;
    }
    else if (event.keyCode == 50) {
      display_element.querySelector('#jspsych-html-slider-response-response').stepUp(trial.step);
      display_element.querySelector('#jspsych-html-slider-response-next').disabled = false;
    }
    else if (event.keyCode == 51 && display_element.querySelector('#jspsych-html-slider-response-next').disabled == false) {
